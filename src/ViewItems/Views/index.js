...
const Views = ({ listItems, removeItem, editItem, currency, handleClearAll, darkMode, filteredData }) => {
    ...
    const handleGridView = () => {
        if (listItems.length === 0) {
            handleOpen("Üzgünüm, listede izgara görünümünü görüntülemek için öğe yok");
        }
        setView(true);
    };
    ...
    const handleListView = () => {
        if (listItems.length === 0) {
            handleOpen("Üzgünüz, listede izgara görünümünü görüntülemek için öğe yok");
        }
        setView(false);
    };
